...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'My LG front-load washing machine was not spinning. Called PravinService at 10am and the technician was here by 11:15am. Fixed within 45 minutes! Very professional and the price was totally fair.',
    avatar: 'PR',
    color: 'bg-blue-500',
  },
  {
    ...
    rating: 5,
    text: 'Samsung double door fridge stopped cooling. PravinService diagnosed gas leak, refilled and fixed in 2 hours. 3 months later, still working perfectly. Highly recommend!',
    avatar: 'KS',
    color: 'bg-orange-500',
  },
  {
  ...
  },
  {
    ...
    service: 'Washing Machine Repair',
    rating: 5,
    text: 'IFB top-load machine motor was gone. Got genuine motor replacement with 90-day warranty. The price was upfront — no hidden charges at all. Will use again!',
    avatar: 'VA',
    color: 'bg-green-500',
  },
  {
  ...
  },
  {
    ...
    service: 'Washing Machine Repair',
    rating: 5,
    text: 'Service was fast, technician was courteous and cleaned up after the repair. The machine is working like new. Excellent 5-star service from PravinService!',
    avatar: 'RV',
    color: 'bg-cyan-500',
  },
]
