...
const services = [
  {
    ...
    price: 'From ₹299',
    features: ['Front Load & Top Load', 'All Major Brands', 'Same-Day Repair', 'Genuine Spare Parts'],
  ...
  },
  {
    ...
    price: 'From ₹399',
    features: ['Single & Double Door', 'Gas Refilling', 'Compressor Repair', 'Genuine Spare Parts'],
  ...
  },
  {
    ...
    price: 'From ₹499',
    features: ['All Dishwasher Types', 'Error Code Diagnosis', 'Drain & Pump Repair', 'Genuine Spare Parts'],
